...
public class GLShaders {
    ...
    static public String printShaderInfoLog(GL3 gl, int obj) {  // Otherwise, we'll get the GL info log
    ...
    static public String printProgramInfoLog(GL3 gl, int obj) {  // get the GL info log
    ...
    static public String textFileRead(String filePath) {  // Read the data in
        BufferedReader reader = null;
        System.out.println("Load Shader: " + filePath);
        try {  // Read in the source
